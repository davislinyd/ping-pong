...
- warning banners include a persistent mobile hotspot data-plan warning, plus local self-test and concurrent test capacity warnings when applicable; allowed local self-tests also show `Local throttled`
